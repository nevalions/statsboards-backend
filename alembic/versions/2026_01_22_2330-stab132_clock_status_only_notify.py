"""clock triggers only notify on status change

Revision ID: stab132_clock_status_only_notify
Revises: stab130_gameclock_full_data
...
revision: str = "stab132_clock_status_only_notify"
down_revision: Union[str, None] = "stab130_gameclock_full_data"
