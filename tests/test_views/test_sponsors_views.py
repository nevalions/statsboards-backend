...
from src.sponsors.views import api_sponsor_router
...
class TestSponsorViews:
    async def test_create_sponsor_endpoint(self, client, test_db):
        ...
        response = client.post("/api/sponsors/", json=sponsor_data.model_dump())
    ...
    async def test_update_sponsor_endpoint(self, client, test_db):
        ...
        response = client.put(f"/api/sponsors/", params={"item_id": created.id}, json=update_data.model_dump())
    ...
    async def test_update_sponsor_not_found(self, client):
        ...
        response = client.put(f"/api/sponsors/", params={"item_id": 99999}, json=update_data.model_dump())
