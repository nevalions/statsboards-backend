...
class TestFootballEventServiceDB:
    ...
    async def test_get_match_football_events_by_match_id(self, test_db):
        ...
        event_service = FootballEventServiceDB(test_db)
        event1 = await event_service.create(FootballEventSchemaCreate(match_id=match.id, event_number=1))
        event2 = await event_service.create(FootballEventSchemaCreate(match_id=match.id, event_number=2))
