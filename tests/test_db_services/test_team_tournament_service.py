...
class TestTeamTournamentServiceDB:
    ...
    async def test_get_team_tournament_relation(self, test_db):
        ...
        result = await team_tournament_service.get_team_tournament_relation(team.id, tournament.id)
    ...
    async def test_get_related_teams(self, test_db):
        ...
        team_tournament_service = TeamTournamentServiceDB(test_db)
        await team_tournament_service.create(TeamTournamentSchemaCreate(team_id=team1.id, tournament_id=tournament.id))
        await team_tournament_service.create(TeamTournamentSchemaCreate(team_id=team2.id, tournament_id=tournament.id))
        await team_tournament_service.create(TeamTournamentSchemaCreate(team_id=team3.id, tournament_id=tournament.id))
    ...
    async def test_delete_relation_by_team_and_tournament_id(self, test_db):
        ...
        team_tournament_service = TeamTournamentServiceDB(test_db)
        await team_tournament_service.create(TeamTournamentSchemaCreate(team_id=team.id, tournament_id=tournament.id))
        
        await team_tournament_service.delete_relation_by_team_and_tournament_id(team.id, tournament.id)
