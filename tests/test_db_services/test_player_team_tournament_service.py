...
from tests.factories import TeamFactory, TournamentFactory, SeasonFactorySample, SportFactorySample, PersonFactory, PlayerFactory, PositionFactory
...
class TestPlayerTeamTournamentServiceDB:
    async def test_create_player_team_tournament(self, test_db):
        ...
        player = await player_service.create(PlayerFactory.build(sport_id=sport.id, person_id=person.id))
        ...
        result = await player_tournament_service.create_new_player_team_tournament(player_tournament_data)
    ...
    async def test_create_or_update_player_team_tournament_with_eesl_id(self, test_db):
        ...
        result = await player_tournament_service.create_or_update_player_team_tournament(player_tournament_data)
    ...
    async def test_get_player_team_tournament_by_eesl_id(self, test_db):
        ...
        created = await player_tournament_service.create_new_player_team_tournament(player_tournament_data)
        result = await player_tournament_service.get_player_team_tournament_by_eesl_id(200)
    ...
    async def test_get_player_team_tournaments_by_tournament_id(self, test_db):
        ...
        created = await player_tournament_service.create_new_player_team_tournament(player_tournament_data)
        result = await player_tournament_service.get_player_team_tournaments_by_tournament_id(tournament.id, player.id)
    ...
    async def test_update_player_team_tournament(self, test_db):
        ...
        created = await player_tournament_service.create_new_player_team_tournament(player_tournament_data)
        update_data = PlayerTeamTournamentSchemaUpdate(player_number="15", position_id=position.id)
