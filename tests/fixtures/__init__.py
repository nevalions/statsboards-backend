...
# Import fixtures from fixtures.py and fixtures directory
...
@pytest_asyncio.fixture
async def season(test_db: Database):
...
@pytest_asyncio.fixture
async def sport(test_db: Database):
...
async def position(test_position_service, sport):
    """Create and return a position instance in the database."""
...
async def sponsor(test_sponsor_service):
    """Create and return a sponsor instance in the database."""
...
async def sponsor_line(test_sponsor_line_service):
    """Create and return a sponsor line instance in the database."""
...
def temp_file_with_cyrillic_name(tmp_path):
    """Create a temporary file with a Cyrillic filename for testing."""
