...
async def session_app(session_database):
    ...
    app.include_router(PlayClockAPIRouter(service_name="playclock").route())
    app.include_router(PlayerAPIRouter(service_name="player").route())
    app.include_router(PlayerMatchAPIRouter(service_name="player_match").route())
    app.include_router(PlayerTeamTournamentAPIRouter(service_name="player_team_tournament").route())
    app.include_router(PositionAPIRouter().route())
    app.include_router(ScoreboardAPIRouter(service_name="scoreboard").route())
    app.include_router(SeasonAPIRouter().route())
    app.include_router(SponsorLineAPIRouter(service_name="sponsor_line").route())
    app.include_router(SponsorAPIRouter().route())
    app.include_router(
        SponsorSponsorLineAPIRouter(None, service_name="sponsor_sponsor_line").route()
    )
    app.include_router(TeamTournamentRouter(service_name="team_tournament").route())
    app.include_router(TeamAPIRouter().route())
    app.include_router(TournamentAPIRouter(service_name="tournament").route())
