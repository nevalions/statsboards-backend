...
def handle_service_exceptions(
    ...
    """
    Decorator to handle common service method exceptions.

    Args:
        item_name: Name of the item being operated on (e.g., "TEAM", "MATCH")
        operation: Description of the operation (e.g., "creating", "fetching")
        reraise_not_found: If True, raise HTTPException for NotFoundError, else return return_value_on_not_found
        return_value_on_not_found: Value to return when NotFoundError is caught and reraise_not_found is False

    Example:
        @handle_service_exceptions(item_name="TEAM", operation="creating")
