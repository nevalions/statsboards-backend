...
def register_all_services(database: Database) -> ServiceRegistry:
    ...
    if not registry.has("player_team_tournament"):
        ...
        register_service("player_team_tournament", lambda db: PlayerTeamTournamentServiceDB(db), singleton=False)
    ...
    if not registry.has("sponsor_sponsor_line"):
        ...
        register_service("sponsor_sponsor_line", lambda db: SponsorSponsorLineServiceDB(db), singleton=False)
