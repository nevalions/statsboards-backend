...
class ClassNameAdapter(logging.LoggerAdapter):
    ...
    def __init__(self, logger: logging.Logger, class_instance: Optional[object] = None):
        extra = {'classname': class_instance.__class__.__name__ if class_instance else 'None'}
...
def get_logger(name: str, class_instance: Optional[object] = None) -> logging.LoggerAdapter:
    """
